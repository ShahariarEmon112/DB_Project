...
# Run procedures, functions, triggers, views
Run-SQLFile "$scriptDir\procedures.sql"
Run-SQLFile "$scriptDir\functions.sql"
Run-SQLFile "$scriptDir\triggers.sql"
Run-SQLFile "$scriptDir\views.sql"